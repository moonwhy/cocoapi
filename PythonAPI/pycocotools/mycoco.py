...
if __name__=='__main__':
    coco = COCO('/media/moon/新加卷/学习/目标检测/annotations/instances_val2014.json')  # 完整的json
    coco.download2('./val20', './val20.json', 20)  # 保存图片路径　生成新的json文件位置 随机下载图片数目

'''
————————————————
版权声明：本文为CSDN博主「我能写」的原创文章，遵循
CC
4.0
BY - SA
版权协议，转载请附上原文出处链接及本声明。
原文链接：https: // blog.csdn.net / qq_33500066 / article / details / 86520967
'''